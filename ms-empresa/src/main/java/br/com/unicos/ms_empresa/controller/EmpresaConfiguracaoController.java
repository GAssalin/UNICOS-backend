...
public class EmpresaConfiguracaoController {
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(
                            ...
                            content = @Content(
                                    array = @ArraySchema(
                                            schema = @Schema(implementation = EmpresaConfiguracaoListDTO.class)
                                    )
                            )
                    ),
    ...
    @GetMapping
    public ResponseEntity<Page<EmpresaConfiguracaoListDTO>> listar(@ParameterObject Pageable pageable) {
