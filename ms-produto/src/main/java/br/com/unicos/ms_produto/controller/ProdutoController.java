...
public class ProdutoController {
    ...
    @GetMapping
    public ResponseEntity<Page<ProdutoListDTO>> listar(
    ...
    public ResponseEntity<Page<ProdutoListDTO>> listarPorAtivo(
    ...
    @GetMapping("/pesquisa")
    public ResponseEntity<Page<ProdutoListDTO>> pesquisarPorNome(
